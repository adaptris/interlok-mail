...
public interface MailReceiver extends Iterable<MimeMessage>, Closeable {
   ...
   * 
   * @param type a regular expression compiler, default is "REGEX" which uses java.util regular expressions.
   * 
   */
   ...
   * <p>
   * By default all messages that are retrived have the <b>Flags.Flag.DELETED</b> flag set, which means that if this is set to true
